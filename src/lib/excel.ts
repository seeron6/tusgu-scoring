...
const FIELD_HINTS: Record<StudentField, string[]> = {
  ...
  listening_category: ["listening category", "listening cat"],
  listening_code: ["listening code", "listen code"],
  flash_category: ["flash category", "flash cat", "flash"],
  centre: ["center name", "centre name", "centre", "center", "school", "branch"],
  teacher: ["ci name", "teacher", "tutor", "instructor", "coach"],
  ci_code: ["ci code"],
  ci_category: ["ci category"],
  franchisee_category: ["franchisee category", "franchise category"],
...
export function previewStudentImport(
  ...
  rows.forEach((raw, idx) => {
    ...
    const data: StudentInsert = {
      ...
      listening_position: null,
      listening_trophy_id: null,
      flash_category: get(mapping.flash_category) || null,
      flash_position: null,
      flash_trophy_id: null,
      centre: get(mapping.centre) || null,
      teacher: get(mapping.teacher) || null,
      ci_code: get(mapping.ci_code) || null,
      ci_category: get(mapping.ci_category) || null,
      franchisee_category: get(mapping.franchisee_category) || null,
